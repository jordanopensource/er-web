...
<script>
    ...
    export default {
        ...
        data() {
            return {
                note1: '* إذا كنت متردداً ، يرجى مكالمتنا عبر رقم الطوارئ',
                note2: '** ساعات العمل لدينا من 9 صباحًا إلى 9 مساءً بتوقيت الأردن',
                ...
                emailCard: {
                    ...
                    iconName: "envelope",
                    email: "er@jordanopensource.org"
                },
                phoneCard: {
                    name: "phone",
                    arabicName: "الهاتف الخلوي",
                    iconName: "phone-alt",
                    phone: "07 7070 0099"
                },
            }
